...
/**
 * Curated picker set — only icons that make sense as an expense/income
 * category. This is what the icon pickers render.
 */
export const CATEGORY_ICONS: CategoryIconOption[] = [
  // Food & Drink
  { name: 'utensils',       icon: Utensils,     hue: 28  }, { name: 'coffee',        icon: Coffee,       hue: 28  },
  { name: 'pizza',          icon: Pizza,        hue: 20  }, { name: 'cooking-pot',   icon: CookingPot,   hue: 28  },
  ...
  { name: 'fish',           icon: Fish,         hue: 205 }, { name: 'apple',         icon: Apple,        hue: 5   },
  { name: 'milk',           icon: Milk,         hue: 200 }, { name: 'cup-soda',      icon: CupSoda,      hue: 195 },
  // Transport
  ...
  { name: 'bike',           icon: Bike,         hue: 118 }, { name: 'truck',         icon: Truck,        hue: 205 },
  // Shopping
  { name: 'shopping-bag',   icon: ShoppingBag,  hue: 320 }, { name: 'shopping-cart', icon: ShoppingCart, hue: 200 },
  { name: 'shirt',          icon: Shirt,        hue: 210 }, { name: 'gem',           icon: Gem,          hue: 265 },
  { name: 'gift',           icon: Gift,         hue: 330 }, { name: 'store',         icon: Store,        hue: 200 },
  { name: 'handbag',        icon: Handbag,      hue: 320 }, { name: 'credit-card',   icon: CreditCard,   hue: 215 },
  { name: 'receipt',        icon: Receipt,      hue: 200 }, { name: 'tag',           icon: Tag,          hue: 200 },
  // Entertainment
  ...
  { name: 'camera',         icon: Camera,       hue: 210 }, { name: 'ticket',        icon: Ticket,       hue: 265 },
  { name: 'party-popper',   icon: PartyPopper,  hue: 45  }, { name: 'palette',       icon: Palette,      hue: 28  },
  // Home & Utilities
  ...
  { name: 'bed',            icon: Bed,          hue: 200 }, { name: 'washing-machine', icon: WashingMachine, hue: 195 },
  { name: 'wifi',           icon: Wifi,         hue: 210 },
  // Health
  { name: 'pill',           icon: Pill,         hue: 118 }, { name: 'hospital',      icon: Hospital,     hue: 5   },
  { name: 'heart-pulse',    icon: HeartPulse,   hue: 0   }, { name: 'stethoscope',   icon: Stethoscope,  hue: 195 },
  { name: 'glasses',        icon: Glasses,      hue: 210 }, { name: 'paw-print',     icon: PawPrint,     hue: 32  },
  { name: 'leaf',           icon: Leaf,         hue: 118 },
  // Work & Finance
  ...
  { name: 'wallet',         icon: Wallet,       hue: 118 }, { name: 'calculator',    icon: Calculator,   hue: 210 },
  { name: 'trending-up',    icon: TrendingUp,   hue: 118 }, { name: 'landmark',      icon: Landmark,     hue: 215 },
  { name: 'percent',        icon: Percent,      hue: 48  }, { name: 'phone',         icon: Phone,        hue: 118 },
  // Education
  { name: 'graduation-cap', icon: GraduationCap, hue: 215 }, { name: 'school',       icon: School,       hue: 215 },
  { name: 'pencil',         icon: Pencil,       hue: 48  }, { name: 'book-open',     icon: BookOpen,     hue: 215 },
  { name: 'notebook-pen',   icon: NotebookPen,  hue: 215 },
  // Travel & Nature
  { name: 'compass',        icon: Compass,      hue: 200 }, { name: 'map-pin',       icon: MapPin,       hue: 5   },
  { name: 'mountain',       icon: Mountain,     hue: 205 }, { name: 'tent',          icon: Tent,         hue: 118 },
  { name: 'tree-palm',      icon: TreePalm,     hue: 118 }, { name: 'sun',           icon: Sun,          hue: 48  },
  { name: 'flower',         icon: Flower,       hue: 330 }, { name: 'umbrella',      icon: Umbrella,     hue: 200 },
  // Misc
  ...
  { name: 'dog',            icon: Dog,          hue: 32  }, { name: 'cat',           icon: Cat,          hue: 32  },
  { name: 'calendar',       icon: Calendar,     hue: 215 }, { name: 'file-text',     icon: FileText,     hue: 215 },
];

/**
 * Icons removed from the picker but still referenced by categories saved
 * before the trim — kept resolvable so old data renders unchanged. Never
 * shown as a choice for new categories.
 */
const LEGACY_CATEGORY_ICONS: CategoryIconOption[] = [
  // Food & Drink
  { name: 'wine',           icon: Wine,         hue: 350 }, { name: 'sandwich',      icon: Sandwich,     hue: 32  },
  ...
  { name: 'soup',           icon: Soup,         hue: 28  }, { name: 'candy',         icon: Candy,        hue: 315 },
  { name: 'popcorn',        icon: Popcorn,      hue: 48  }, { name: 'banana',        icon: Banana,       hue: 55  },
  { name: 'cherry',         icon: Cherry,       hue: 350 }, { name: 'grape',         icon: Grape,        hue: 280 },
  { name: 'carrot',         icon: Carrot,       hue: 25  }, { name: 'leafy-green',   icon: LeafyGreen,   hue: 118 },
  { name: 'wheat',          icon: Wheat,        hue: 48  }, { name: 'egg',           icon: Egg,          hue: 48  },
  { name: 'egg-fried',      icon: EggFried,     hue: 45  }, { name: 'chef-hat',      icon: ChefHat,      hue: 220 },
  { name: 'cake-slice',     icon: CakeSlice,    hue: 320 }, { name: 'dessert',       icon: Dessert,      hue: 315 },
  { name: 'vegan',          icon: Vegan,        hue: 118 },
  // Transport
  { name: 'luggage',        icon: Luggage,      hue: 205 }, { name: 'ship',          icon: Ship,         hue: 205 },
  ...
  // Shopping
  { name: 'scissors',       icon: Scissors,     hue: 0   }, { name: 'backpack',      icon: Backpack,     hue: 210 },
  { name: 'sparkles',       icon: Sparkles,     hue: 50  }, { name: 'diamond',       icon: Diamond,      hue: 265 },
  ...
  // Home & Utilities
  { name: 'refrigerator',   icon: Refrigerator, hue: 195 }, { name: 'microwave',     icon: Microwave,    hue: 200 },
  { name: 'fan',            icon: Fan,          hue: 190 }, { name: 'hammer',        icon: Hammer,       hue: 28  },
  ...
  { name: 'database',       icon: Database,     hue: 215 }, { name: 'cog',           icon: Cog,          hue: 200 },
  // Health
  { name: 'heart',          icon: Heart,        hue: 350 }, { name: 'activity',      icon: Activity,     hue: 118 },
  ...
  { name: 'ambulance',      icon: Ambulance,    hue: 5   }, { name: 'briefcase-medical', icon: BriefcaseMedical, hue: 118 },
  { name: 'test-tube',      icon: TestTube,     hue: 195 }, { name: 'microscope',    icon: Microscope,   hue: 195 },
  { name: 'dna',            icon: Dna,          hue: 118 }, { name: 'flask-conical', icon: FlaskConical, hue: 185 },
  { name: 'atom',           icon: Atom,         hue: 270 }, { name: 'footprints',    icon: Footprints,   hue: 32  },
  // Work & Finance
  { name: 'globe',          icon: Globe,        hue: 200 }, { name: 'tv',            icon: Tv,           hue: 215 },
  { name: 'cpu',            icon: Cpu,          hue: 215 }, { name: 'building',      icon: Building,     hue: 215 },
  { name: 'building-2',     icon: Building2,    hue: 215 }, { name: 'vault',         icon: Vault,        hue: 32  },
  { name: 'dollar-sign',    icon: DollarSign,   hue: 118 }, { name: 'newspaper',     icon: Newspaper,    hue: 205 },
  { name: 'projector',      icon: Projector,    hue: 215 }, { name: 'mail',          icon: Mail,         hue: 205 },
  { name: 'contact',        icon: Contact,      hue: 205 },
  // Education
  { name: 'library',        icon: Library,      hue: 215 }, { name: 'award',         icon: Award,        hue: 48  },
  { name: 'notebook',       icon: Notebook,     hue: 215 }, { name: 'eraser',        icon: Eraser,       hue: 330 },
  { name: 'pen',            icon: Pen,          hue: 215 },
  // Travel & Nature
  { name: 'flag',           icon: Flag,         hue: 5   }, { name: 'moon',          icon: Moon,         hue: 265 },
  { name: 'snowflake',      icon: Snowflake,    hue: 195 }, { name: 'waves',         icon: Waves,        hue: 200 },
  { name: 'trees',          icon: Trees,        hue: 118 }, { name: 'tree-deciduous', icon: TreeDeciduous, hue: 118 },
  { name: 'tree-pine',      icon: TreePine,     hue: 118 }, { name: 'clover',        icon: Clover,       hue: 118 },
  { name: 'binoculars',     icon: Binoculars,   hue: 205 }, { name: 'flashlight',    icon: Flashlight,   hue: 48  },
  { name: 'satellite',      icon: Satellite,    hue: 215 }, { name: 'rocket',        icon: Rocket,       hue: 270 },
  { name: 'sprout',         icon: Sprout,       hue: 118 },
  // Misc
  { name: 'sword',          icon: Sword,        hue: 205 }, { name: 'shield',        icon: Shield,       hue: 205 },
  { name: 'watch',          icon: Watch,        hue: 200 }, { name: 'bird',          icon: Bird,         hue: 200 },
  { name: 'timer',          icon: Timer,        hue: 210 }, { name: 'hourglass',     icon: Hourglass,    hue: 48  },
  { name: 'alarm-clock',    icon: AlarmClock,   hue: 210 }, { name: 'goal',          icon: Goal,         hue: 118 },
  { name: 'milestone',      icon: Milestone,    hue: 200 }, { name: 'scan-barcode',  icon: ScanBarcode,  hue: 215 },
  { name: 'scan-qr-code',   icon: ScanQrCode,   hue: 215 },
];

function findIcon(iconName?: string): CategoryIconOption | undefined {
  if (!iconName) return undefined;
  return (
    CATEGORY_ICONS.find((i) => i.name === iconName) ||
    LEGACY_CATEGORY_ICONS.find((i) => i.name === iconName)
  );
}

export function getIconData(iconName?: string): LucideIconData {
  return findIcon(iconName)?.icon ?? Tag;
}

export function getIconHue(iconName?: string): number {
  return findIcon(iconName)?.hue ?? 200;
}
